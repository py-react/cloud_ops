...
class RepoRequest(BaseModel):
    ...
    registry_id: Optional[int] = Field(None, description="ID of the Docker Registry to use")
...
async def POST(request: Request, body: RepoRequest):
    ...
    try:
        ...
        utils.add_repository(repo_name=body.name, repo_id=body.name, branches=body.branches, pat_id=body.pat_id, registry_id=body.registry_id)
...
async def PUT(request: Request, body: RepoRequest):
    ...
    try:
        utils = AllowedRepoUtils()
        utils.update_branches(repo_name=body.name, branches=body.branches, pat_id=body.pat_id, registry_id=body.registry_id)
