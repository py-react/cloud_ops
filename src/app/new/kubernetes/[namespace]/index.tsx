...
function Kubernetes() {
  ...
  const fetchNamespaceDetails = useCallback(async () => {
    ...
    try {
      const result: any = await DefaultService.apiKubernertesNamespacesNamespaceGet({ namespace });
  ...
  const fetchNamespaceMetrics = useCallback(async () => {
    ...
    try {
      const result: any = await DefaultService.apiKubernertesClusterMetricsNamespaceNamespaceGet({ namespace });
      if (result.status === "success") {
      ...
      actions={
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="h-9"
            onClick={() => {
              navigate(`/new/kubernetes/${namespace}/flow`);
            }}
          >
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          <ResourceCard
            ...
            onClick={() => navigate(`/new/kubernetes/${namespace}/pods`)}
          />
          <ResourceCard
            title="Deployments"
            ...
            isLoading={isLoadingNsDetails}
            onClick={() => navigate(`/new/kubernetes/${namespace}/deployments`)}
          />
          <ResourceCard
            title="Services"
            ...
            isLoading={isLoadingNsDetails}
            onClick={() => navigate(`/new/kubernetes/${namespace}/services`)}
          />
          <ResourceCard
            title="ConfigMaps"
            ...
            isLoading={isLoadingNsDetails}
            onClick={() => navigate(`/new/kubernetes/${namespace}/configmaps`)}
          />
          <ResourceCard
            title="Secrets"
            ...
            isLoading={isLoadingNsDetails}
            onClick={() => navigate(`/new/kubernetes/${namespace}/secrets`)}
          />
        </div>
