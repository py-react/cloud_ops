...
const ContainersPage = () => {
  ...
  // Trigger refetch whenever activeEngineId changes
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <ResourceCard
          title="Status"
          count={globalError ? "Disconnected" : "Healthy"}
          icon={<ShieldCheck className="w-4 h-4" />}
          color={globalError ? "bg-destructive" : "bg-indigo-500"}
          className={globalError ? "border-destructive/20 bg-destructive/5 shadow-none hover:border-destructive/30 transition-all" : "border-indigo-500/20 bg-indigo-500/5 shadow-none hover:border-indigo-500/30 transition-all"}
          isLoading={isLoading}
        />
      </div>
