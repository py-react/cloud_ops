...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background/80 backdrop-blur-xl p-6 shadow-2xl transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out border-border/50",
  {
    variants: {
      side: {
