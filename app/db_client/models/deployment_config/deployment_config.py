...
class DeploymentConfig(SQLModel, table=True):
    ...
    node_selector: Optional[Dict[str, str]] = Field(default=None, sa_column=Column(JSONB))
    tolerations: Optional[List[Dict[str, Any]]] = Field(default=None, sa_column=Column(JSONB))
